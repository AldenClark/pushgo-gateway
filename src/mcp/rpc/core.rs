        ...
        json!({
          "tools": [
            ...
            },
            {
              ...
              "inputSchema": {"type":"object","additionalProperties":false,"required":["channel_id"],"properties":{"channel_id":{"type":"string"},"password":{"type":"string"},"op_id":{"type":"string"},"thing_id":{"type":"string"},"event_time":{"type":"integer"},"title":{"type":"string"},"description":{"type":"string"},"status":{"type":"string"},"message":{"type":"string"},"severity":{"type":"string"},"tags":{"type":"array","items":{"type":"string"}},"images":{"type":"array","items":{"type":"string"}},"ciphertext":{"type":"string","description":"可选密文(JSON字符串)，仅使用当前接口同名业务字段"},"started_at":{"type":"integer"},"ended_at":{"type":"integer"},"attrs":{"type":"object"},"metadata":{"type":"object"}}}
            },
            {
