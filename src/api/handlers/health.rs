    ...
    fn snapshot(
        ...
        PrivateHealthSnapshot {
            ...
            metrics: PrivateMetricsSnapshot {
                ...
                mqtt_protocol_errors: 0,
                mqtt_publish_success: 0,
                mqtt_publish_failures: 0,
                mqtt_subscribe_success: 0,
                mqtt_subscribe_failures: 0,
                mqtt_unsubscribe_success: 0,
                mqtt_unsubscribe_failures: 0,
                mqtt_downlink_sent: 0,
                mqtt_downlink_failures: 0,
                mqtt_downlink_dropped: 0,
                mqtt_bootstrap_dropped: 0,
                mqtt_will_sent: 0,
                mqtt_will_failures: 0,
                mqtt_will_rejected: 0,
                hello_timeouts: 0,
                auth_failures: 0,
