...
pub(super) async fn record_private_realtime_skip(
    prepared: &PreparedDispatch<'_>,
    device: &DeviceInfo,
    provider_audit_key: String,
) {
    append_delivery_audit_best_effort(
        ...
        &DeliveryAuditWrite {
            ...
            status: AUDIT_STATUS_SKIPPED_PRIVATE_REALTIME,
            error_code: None,
    ...
    prepared.state.dispatch_audit.record(DispatchAuditRecord {
        ...
        provider: Some(device.platform.provider_name()),
