...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
pub struct DeviceRuntimeCounterBucket {
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
pub struct GatewayRuntimeCounterBucket {
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
pub struct OpsRuntimeCounterBucket {
    pub bucket_hour: String,
...
impl MaintenanceCleanupConfig {
    ...
    pub fn normalized(mut self) -> Self {
        ...
        self.frozen_subscription_ttl_secs =
            normalize_positive_secs(self.frozen_subscription_ttl_secs, 30);
    ...
    pub fn frozen_subscription_before(self, now: i64) -> i64 {
        before_from_ttl(now, self.frozen_subscription_ttl_secs)
    }
...
mod tests {
    ...
    #[test]
    fn maintenance_cleanup_config_keeps_dedupe_retention() {
    ...
    #[test]
    fn maintenance_cleanup_config_preserves_dry_run() {
        let config = MaintenanceCleanupConfig {
            dry_run: true,
            ..MaintenanceCleanupConfig::default()
        }
